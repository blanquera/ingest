 ...
 */
function makeArray(object: NestedObject<unknown>): any[] {
  const array: any[] = [];
 ...
 */
function makeObject(array: any[]): NestedObject<unknown> {
 ...
 */
function shouldBeAnArray(object: NestedObject<unknown>): boolean {
