...
import { createSourceFile } from '@blanquera/ingest/dist/buildtime/helpers';
import HTTPBuilder from '@blanquera/ingest/dist/http/Builder';
...
export default class Builder extends HTTPBuilder{
  ...
  public transpile(info: TranspileInfo) {
    ...
    //import Server from '@blanquera/ingest-vercel/dist/Server';
    source.addImportDeclaration({
      moduleSpecifier: '@blanquera/ingest-vercel/dist/Server',
