      ...
      run(req, res, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          while (this.queue.length) {
            const task3 = this.queue.shift();
            if ((yield task3.callback(req, res, ctx)) === false) {
...
// ingest-plugin:/Users/cblanquera/server/projects/blanquera/ingest/examples/with-vercel/api/7685d93174afc2996613.ts
var d93174afc2996613_exports = {};
__export(d93174afc2996613_exports, {
  GET: () => GET
});
module.exports = __toCommonJS(d93174afc2996613_exports);
...
var bar_default = (0, import_ingest.task)(function hello(req, res, ctx) {
...
// src/pages/zoo.ts
var import_ingest2 = __toESM(require_ingest());
var zoo_default = (0, import_ingest2.task)(function hello2(req, res, ctx) {
...
function GET(request) {
  ...
  queue.add(bar_default);
  queue.add(zoo_default);
